...
<tr valign="top" >
	<td scope="row">
		<label for="feature">'.__('Select type','placid-slider').'</label>
	</td> 
	<td>
...
<tr valign="top" class="pxuser" style="display:none;">
	<td scope="row">
		<label for="username" id="flickr-lb">'.__('User Name','placid-slider').'</label></td> 
	<td>
		<input type="text" name="username" class="ps-form-input" />
	</td>
</tr>
';
print($html);
