...
<tr valign="top" >
	...
	<td>
		<div class="styled-select">
			<select name="type" class="flickr-type ps-form-input" >
...
<tr valign="top">
	<td scope="row">
		<label for="id" id="flickr-lb">'.__('User ID','placid-slider').'</label></td> 
	<td>
		<input type="text" name="id" id="fl-user-id" class="ps-form-input" />
	</td>
</tr>
';
print($html);
