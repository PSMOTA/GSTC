...
abstract class CRM_Utils_Hook {
  ...
  /**
   * This hook is called when On Behalf of Orangazation is used.
   *
   * @see CRM_Core_Resources::coreResourceList
   *
   * @param array $list
   * @param string $region
   */
  public static function onbehalfOtherRelationship($ind, $org) {
    self::singleton()->invoke(2, $ind, $org,
      self::$_nullObject, self::$_nullObject, self::$_nullObject, self::$_nullObject,
      'civicrm_onbehalfOtherRelationship'
    );
  }
