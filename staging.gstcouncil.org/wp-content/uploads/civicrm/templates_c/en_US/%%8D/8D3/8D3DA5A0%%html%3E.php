    ...
    <table style = "padding-right:19px;font-family: Arial, Verdana, sans-serif;" width = "590" height = "100" border = "0" cellpadding = "2" cellspacing = "1">
      ...
      <tr>
        <td width="30%" style="" valign="top">
          <table>
            <tr><td><font size = "1" align = "center"  type="Test Membership">{if $organization_name and $membership_owner}{$display_name} ({$organization_name}){else}{$display_name}{/if}</font></td></tr>
  ...
  <body>
    ...
    <table style = "padding-right:19px;font-family: Arial, Verdana, sans-serif;" width = "590" height = "100" border = "0" cellpadding = "2" cellspacing = "1">
      ...
      <tr>
        <td width="30%" style="" valign="top">
          <table>
            <tr><td><font size = "1" align = "center"  type="Test Membership"><?php if ($this->_tpl_vars['organization_name'] && $this->_tpl_vars['membership_owner']): ?><?php echo $this->_tpl_vars['display_name']; ?>
