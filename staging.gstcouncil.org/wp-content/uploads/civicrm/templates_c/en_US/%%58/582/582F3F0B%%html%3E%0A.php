    ...
    {if $event.allow_selfcancelxfer }
     <tr>
      <td colspan="2" {$valueStyle}>
        ...
        {capture assign=selfService}{crmURL p=\'civicrm/event/selfsvcupdate\' q="reset=1&pid=`$participant.id`&cs=5944dc0cf83307eee5142ca138be1114_1498166254_360"  h=0 a=1 fe=1}{/capture}
...
>
        ...
        <?php ob_start(); ?><?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/event/selfsvcupdate','q' => "reset=1&pid=".($this->_tpl_vars['participant']['id'])."&cs=5944dc0cf83307eee5142ca138be1114_1498166254_360",'h' => 0,'a' => 1,'fe' => 1), $this);?>
