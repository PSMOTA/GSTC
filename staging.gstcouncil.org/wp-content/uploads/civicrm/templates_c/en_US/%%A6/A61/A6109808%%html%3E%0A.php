    ...
    {if $event.allow_selfcancelxfer }
     <tr>
      <td colspan="2" {$valueStyle}>
        ...
        {capture assign=selfService}{crmURL p=\'civicrm/event/selfsvcupdate\' q="reset=1&pid=`$participant.id`&cs=059b1041941ede6bb2123be5e4bbbf3b_1497974547_360"  h=0 a=1 fe=1}{/capture}
...
>
        ...
        <?php ob_start(); ?><?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/event/selfsvcupdate','q' => "reset=1&pid=".($this->_tpl_vars['participant']['id'])."&cs=059b1041941ede6bb2123be5e4bbbf3b_1497974547_360",'h' => 0,'a' => 1,'fe' => 1), $this);?>
