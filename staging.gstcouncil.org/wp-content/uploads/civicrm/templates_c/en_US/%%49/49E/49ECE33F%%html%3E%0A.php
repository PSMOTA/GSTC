    ...
    {if $event.allow_selfcancelxfer }
     <tr>
      <td colspan="2" {$valueStyle}>
        ...
        {capture assign=selfService}{crmURL p=\'civicrm/event/selfsvcupdate\' q="reset=1&pid=`$participant.id`&cs=e9fc219580bf3d2f527263edf3c0e4c3_1498456412_360"  h=0 a=1 fe=1}{/capture}
...
>
        ...
        <?php ob_start(); ?><?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/event/selfsvcupdate','q' => "reset=1&pid=".($this->_tpl_vars['participant']['id'])."&cs=e9fc219580bf3d2f527263edf3c0e4c3_1498456412_360",'h' => 0,'a' => 1,'fe' => 1), $this);?>
